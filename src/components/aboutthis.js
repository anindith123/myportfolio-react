...
class Aboutthis extends Component {
    render() {
        return <section className = "abouthisComponent">
        <div>
...
<center><p><h4 className="aboutthisHeading">I have designed, developed, deployed this single-page mobile friendly application website with all of my knowledge and passion towards web development.</h4><br/>
 <h4 className="aboutthisHeading">Created using Django, React, HTML, CSS, Bootstrap, javascript</h4></p></center>
<div className="aboutthis">
<center><h4 className="aboutthisHeading">Front end/Design</h4></center><br/>
<ul>
    <li>
...
<center><h4 className="aboutthisHeading">Backend</h4></center><br/>
<ul>
